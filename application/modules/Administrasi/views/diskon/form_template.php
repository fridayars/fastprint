        ...
        <form action="" method="post" class="form-horizontal" enctype="multipart/form-data">
            <div class="card-body">
                <div class="form-group">
                    ...
                    <input type="text" name="nama_template" required class="form-control" value="<?= set_value('nama') ?>">
                </div>
                <div class="form-group">
                    <label for="kategori">Gambar Template</label>
                    <input type="file" name="file_url" class="form-control" accept="image/png, image/jpeg, image/jpg" id="imgInp" required>
                    <code>max size 2mb, file accept : png, jpeg, jpg.</code>
                    <br>
                    <img id="blah" src="#" alt="Preview Template" height="200px"/>
                </div>
                <div class="card-footer">
                    <button type="submit" class="btn btn-info">Tambah Template</button>
                </div>
            </div>
            <!-- /.card-body -->
        </form>
